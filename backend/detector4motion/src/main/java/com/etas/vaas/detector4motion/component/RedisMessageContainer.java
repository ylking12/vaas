 ...
 *  com.etas.vaas.detector4motion.component.RedisMessageContainer
...
import com.etas.vaas.detector4motion.component.RedisSubscriber;
...
public class RedisMessageContainer {
    ...
    public RedisMessageListenerContainer messageListenerContainer(RedisConnectionFactory redisConnectionFactory, RedisSubscriber redisSubscriber) {
        ...
        String channel = this.redisKeyConfig.getInstance().getMotionTopic();
