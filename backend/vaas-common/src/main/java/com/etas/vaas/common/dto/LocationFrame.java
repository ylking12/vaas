...
public class LocationFrame {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LocationFrame)) {
            return false;
        }
        LocationFrame other = (LocationFrame)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LocationFrame;
    }
    ...
    public String toString() {
        return "LocationFrame(deviceId=" + this.getDeviceId() + ", longitude=" + this.getLongitude() + ", latitude=" + this.getLatitude() + ", timestamp=" + this.getTimestamp() + ")";
    }
}
